# Phase 7 — C/C++ (compiled languages)
...
**Mitigations (inherited from Phase 6):**
...
Everything below must be checked before marking Phase 7 as done.
...
- [ ] `CHANGELOG.md` entry added for Phase 7
