...
Laravel and Symfony require Composer; Express and NestJS require npm. End users of the installed app do not run this; only developers and release builds do.
