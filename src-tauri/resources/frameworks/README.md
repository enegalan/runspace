...
Laravel, Symfony, Express, and Echo sandboxes are **not** stored in git. They are generated locally or in CI by:
...
Laravel and Symfony require Composer; Express requires npm; Echo requires Go. End users of the installed app do not run this; only developers and release builds do.
