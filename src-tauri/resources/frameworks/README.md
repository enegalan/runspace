...
Laravel, Symfony, Express, and Nancy sandboxes are **not** stored in git. They are generated locally or in CI by:
...
Laravel and Symfony require Composer; Express requires npm; Nancy requires the .NET SDK. End users of the installed app do not run this; only developers and release builds do.
