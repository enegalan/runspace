...
Laravel, Symfony, Express, and Dash sandboxes are **not** stored in git. They are generated locally or in CI by:
...
Laravel and Symfony require Composer; Express requires npm; Dash requires Python with pip. End users of the installed app do not run this; only developers and release builds do.
