...
Laravel, Symfony, Express, and Quarkus sandboxes are **not** stored in git. They are generated locally or in CI by:
...
Laravel and Symfony require Composer; Express requires npm; Quarkus requires curl (and Maven for end-user dependency install). End users of the installed app do not run this; only developers and release builds do.
