...
Laravel, Symfony, Express, ASP.NET Core, and Poem sandboxes are **not** stored in git. They are generated locally or in CI by:
...
Laravel and Symfony require Composer; Express requires npm; ASP.NET Core requires the .NET SDK; Poem requires Cargo. End users of the installed app do not run this; only developers and release builds do.
