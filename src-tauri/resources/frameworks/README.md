...
Laravel, Symfony, Express, and Phoenix sandboxes are **not** stored in git. They are generated locally or in CI by:
...
Laravel and Symfony require Composer; Express requires npm; Phoenix requires Elixir, Mix, and the `phx_new` archive. End users of the installed app do not run this; only developers and release builds do.
