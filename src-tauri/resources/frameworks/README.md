...
Laravel and Symfony sandboxes are **not** stored in git. They are generated locally or in CI by:
...
Requires Composer. End users of the installed app do not run this; only developers and release builds do.
