...
Laravel, Symfony, Laminas, and Express sandboxes are **not** stored in git. They are generated locally or in CI by:
...
Laravel, Symfony, and Laminas require Composer; Express requires npm. End users of the installed app do not run this; only developers and release builds do.
